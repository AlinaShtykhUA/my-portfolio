...
const uaData = {
  ...
  "projects-data": [
    ...
    },
    {
      ...
      "coverImg": tenzies,
      "github": {"icon": github, "link": "https://github.com/AlinaShtykhUA/Tenzi-game"},
      "link": {"icon": link, "link": "https://tubular-pithivier-27409e.netlify.app/"}
    },
    {
      "key": 4,
      "title": "Магазин ігр",
      "description": "Сайт магазина ігр на React. З використанням redux-toolkit, router.",
      "coverImg": gameStore,
      "github": {"icon": github, "link": "https://github.com/AlinaShtykhUA/game-store"},
      "link": {"icon": link, "link": "https://6481133e05899f0085b99f42--tiny-snickerdoodle-03d324.netlify.app/"}
    }
  ]
}
