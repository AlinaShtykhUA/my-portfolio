            ...
            <div className="contacts__code code">
              ...
              <div className='code-obj'>
                ...
                <div className='code-line'>
                  ...
                  <span className="colon">:</span>
                  <a rel="noreferrer" target="_blank" href="https://www.linkedin.com/in/alina-shtykh-2b6070188/" className="str">
                    
                    {t('contacts.link')} linkedin
                    <span className="purple">,</span>
                ...
                <div className='code-line'>
                  ...
                  <span className="colon">:</span>
                  <a rel="noreferrer" target="_blank" href="https://github.com/AngelinaShtykh" className="str">
                  {t('contacts.link')} github
                    <span className="purple">,</span>
                  </a>
                </div> 
                ...
                <div className='code-line'>
                  ...
                  <span className="colon">:</span>
                  <a rel="noreferrer" target="_blank" href="https://sweetcv.com/6oezy01tp0w91" className="str">
                  {t('contacts.link')} CV
                  </a>
                </div> 
              </div>   
